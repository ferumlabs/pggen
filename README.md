...
![example workflow](https://github.com/ferumlabs/pggen/actions/workflows/ci.yaml/badge.svg)
[![Go Reference](https://pkg.go.dev/badge/github.com/ferumlabs/pggen.svg)](https://pkg.go.dev/github.com/ferumlabs/pggen)

`pggen` consists of 3 main packages:
  - `github.com/ferumlabs/pggen/cmd/pggen` is a command line tool to be
     invoked in `go:generate` directives.
  - `github.com/ferumlabs/pggen/gen` is the back end for the
    `github.com/ferumlabs/pggen/cmd/pggen` tool. All the command line
  ...
  - `github.com/ferumlabs/pggen` and its subpackages (besides `cmd` and `gen`)

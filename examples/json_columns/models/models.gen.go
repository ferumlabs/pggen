...
func (p *pgClientImpl) bulkInsertUser(
	...
	for _, v := range values {
		...
		if !defaultFields.Test(UserConfigFieldIndex) {
			args = append(args, &nullConvertconfig__PGGENMODSEP__Config{valid: true, value: &v.Config})
		}
...
func (p *pgClientImpl) updateUser(
	...
	if fieldMask.Test(UserConfigFieldIndex) {
		args = append(args, &nullConvertconfig__PGGENMODSEP__Config{valid: true, value: &value.Config})
	}
...
var scannerTabForUser = [...]func(*User, *nullableScanTgtsForUser) interface{}{
	...
	func(
		...
		return &nullConvertconfig__PGGENMODSEP__Config{valid: true, value: &r.Config}
	},
	func(
		r *User,
		nullableTgts *nullableScanTgtsForUser,
...
type nullConvertconfig__PGGENMODSEP__Config struct {
	valid bool
	value *config.Config
}

func (n *nullConvertconfig__PGGENMODSEP__Config) Scan(value interface{}) error {
	if value == nil {
...
func (n nullConvertconfig__PGGENMODSEP__Config) Value() (driver.Value, error) {
	if !n.valid {
		return nil, nil
	}
...
func convertnullConvertconfig__PGGENMODSEP__Config(v nullConvertconfig__PGGENMODSEP__Config) *config.Config {
	if !v.valid {
		return nil
	}
